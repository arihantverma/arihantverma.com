...
Here is how you can embed a UI component inside MDX once that component exists in your project. This starter no longer includes the sample `HeaderLink.astro` component, so the broken import and demo usage have been removed.
